...
export function circle(ctx: CanvasRenderingContext2D, origin: Vec2, radius: number) {
    ...
    //console.log("ctx.arc(" + origin.x + ", " + origin.y + ", " + radius + ", " + 0 + ", " + 2 + "* Math.PI);");
    ctx.closePath();
...
export function cross(ctx: CanvasRenderingContext2D, origin: Vec2, height: number) {
    ...
    //console.log("ctx.moveTo(" + top.x + ", " + top.y + ");");
    ctx.lineTo(bottom.x, bottom.y);
    //console.log("ctx.lineTo(" + bottom.x + ", " + bottom.y + ");");
    ctx.closePath();
    //console.log("ctx.closePath();");

    ctx.moveTo(left.x, left.y);
    //console.log("ctx.moveTo(" + left.x + ", " + left.y + ");");
    ctx.lineTo(right.x, right.y);
    //console.log("ctx.lineTo(" + right.x + ", " + right.y + ");");
    ctx.stroke();
